...
| :-----: | :------------------------------: | :----------: | :------------------------------: | :-----------------------------------------------------------------------------------------------: |
| Nov. 2025 | Enhancing LLM-based E-commerce Purchase Negotiation AI Agents | ***The 37th Annual Conference on Human & Cognitive Language Technology(HCLT 2025), Domestic Conference*** | ***NLP, Agentic LLMs, Domain-specific LLMs*** | *****[Eunchan Lee (Me)](https://github.com/purang2) et al.*****|
| Nov. 2024 | Teaching Large Language Models to Understand Jeju Island with Domain-Adaptive Pretraining | ***2024 2nd International Conference on Foundation and Large Language Models (FLLM), Int Conference*** | ***LLM Training, Domain-Adaptive Pretraining*** | *****[Eunchan Lee (Me)](https://github.com/purang2) et al.*****|
